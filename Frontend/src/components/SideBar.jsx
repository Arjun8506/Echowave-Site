  ...
  return (
    <>
      {menubar ? (
        ...
        <header>
          <div className="fixed w-[10vw] lg:w-[20vw] min-h-screen bg-zinc-200 border-r-[1px] rounded-r-lg z-50">
            <div className=" py-10 px-2">
              ...
              <div className="mt-5 flex flex-col gap-4 lg:ml-5  items-center">
                <Link to={"/"} className="w-fit">
                  <div className=" flex gap-2 items-center">
                    <FaHome className="text-2xl" />
                    <p className="hover:text-blue-600 text-lg  hidden lg:inline">
